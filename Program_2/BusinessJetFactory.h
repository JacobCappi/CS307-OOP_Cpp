...
class BusinessJetFactory: public AircraftAbstractFactory{
    private:
        ...
        vector<AircraftData> businessJetFactory; // Uses Flyweight as each class is only referenced once
    ...
    // virtual get Aircraft() from inheritance;
        ...
        ~BusinessJetFactory();
		static BusinessJetFactory *getInstance();	// Get the singleton instance
